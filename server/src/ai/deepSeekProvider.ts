...
export class DeepSeekProvider implements AIProvider {
  ...
  constructor(apiKey?: string, model?: string) {
    ...
    this.thinkingEnabled = (process.env.DEEPSEEK_THINKING_ENABLED || 'true').toLowerCase() !== 'false';
    this.reasoningEffort = process.env.DEEPSEEK_REASONING_EFFORT === 'max' ? 'max' : 'high';
    if (!this.apiKey) {
